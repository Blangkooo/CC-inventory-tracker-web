...
<head>
    ...
    <title>Business Recipe - NITA</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .branch-dot {
            ...
            height: 40px;
            border-radius: 50%;
            background: rgba(253, 245, 214, 0.9);
            border: 1.5px solid #5C2D1B;
            display: flex;
            align-items: center;
        ...
        .search-bar::placeholder { color: #a0897a; }
        .search-bar:focus { outline: none; border-color: #BC614B; }
        ...
        .cat-pill.active { background: #BC614B; color: #ffffff; border-color: #BC614B; }
        ...
        .recipe-title {
            ...
            margin-bottom: 16px;
            padding-bottom: 10px;
            border-bottom: 2px solid rgba(92, 45, 27, 0.15);
        }
        ...
        .recipe-table thead th {
            ...
            border-bottom: 2px solid #5C2D1B;
        }
        ...
        .recipe-footer {
            ...
            margin-top: 16px;
            padding-top: 16px;
            border-top: 1px solid rgba(92, 45, 27, 0.15);
        }
        ...
        .btn-edit:hover { background: #5C2D1B; color: #FDF5D6; }
...
<body>
    ...
    {{-- ── MAIN WRAPPER (Branch Selector + Content) ── --}}
    <div class="main-wrapper">
        ...
        <div class="content-area">
            ...
            <div class="page-header">
                ...
                <div class="sub-tabs">
                    <a href="{{ url('/business/summary') }}" class="sub-tab">&#128200; Summary</a>
                    <a href="{{ url('/business/recipes') }}" class="sub-tab active">&#127858; Recipe</a>
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:20px;">
                <input type="text" class="search-bar" placeholder="Enter item name" value="">
            </div>

            {{-- Category Pills --}}
            <div class="category-pills">
                <span class="cat-pill active">Drinks</span>
            ...
            <div class="recipe-card">
                <div class="recipe-title">&#9749; Black Forest Milk Tea</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="procedure-text">
                                    ...
                                    2. In a mixing cup, combine chocolate syrup and cherry syrup.<br>
                ...
                <div class="recipe-footer">
                    <span class="recipe-footer-label">Edit the recipe?</span>
